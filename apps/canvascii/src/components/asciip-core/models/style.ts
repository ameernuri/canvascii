...
export type LINE_TEXT_ALIGN = "START" | "CENTER" | "END";
export type RECTANGLE_FILL = "NONE" | "SOLID";
export type RECTANGLE_BORDER = "AUTO" | "NONE" | "LINE" | "BLOCK";
export type RECTANGLE_TEXT_ALIGN_H = "LEFT" | "CENTER" | "RIGHT";
export type RECTANGLE_TEXT_ALIGN_V = "TOP" | "MIDDLE" | "BOTTOM";
export type RECTANGLE_TEXT_WRAP = "OFF" | "WORD";
export type RECTANGLE_TEXT_OVERFLOW = "HIDE" | "TRUNCATE";
...
export type Style = {
  ...
  lineTextAlign: LINE_TEXT_ALIGN;
  lineTextPadding: number;
  rectangleFill: RECTANGLE_FILL;
  rectangleBorder: RECTANGLE_BORDER;
  rectangleTextAlignH: RECTANGLE_TEXT_ALIGN_H;
  rectangleTextAlignV: RECTANGLE_TEXT_ALIGN_V;
  rectangleTextWrap: RECTANGLE_TEXT_WRAP;
  rectangleTextOverflow: RECTANGLE_TEXT_OVERFLOW;
  rectangleTextPadding: number;
};
...
export function resolveRectangleBorder(style: Style): Exclude<RECTANGLE_BORDER, "AUTO"> {
  if (style.rectangleBorder === "AUTO") {
    return style.rectangleFill === "SOLID" ? "NONE" : "LINE";
  }
  return style.rectangleBorder;
}
...
export function getCharRepr(
  ...
  switch (char) {
    ...
    case "RECT_FILL":
      return styleMode === "ASCII" ? "#" : "█";
    case "BLOCK_CORNER_TL":
      return styleMode === "ASCII" ? "+" : "▗";
    case "BLOCK_CORNER_TR":
      return styleMode === "ASCII" ? "+" : "▖";
    case "BLOCK_CORNER_BR":
      return styleMode === "ASCII" ? "+" : "▘";
    case "BLOCK_CORNER_BL":
      return styleMode === "ASCII" ? "+" : "▝";
    case "BLOCK_BORDER_TOP":
      return styleMode === "ASCII" ? "=" : "▄";
    case "BLOCK_BORDER_BOTTOM":
      return styleMode === "ASCII" ? "=" : "▀";
    case "BLOCK_BORDER_LEFT":
      return styleMode === "ASCII" ? "|" : "▐";
    case "BLOCK_BORDER_RIGHT":
      return styleMode === "ASCII" ? "|" : "▌";
  }
